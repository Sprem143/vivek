...
function SEO() {
    ...
    return (
        <>
            <div className="container p-2" style={{ background: 'rgb(28, 28, 103)' }}>
                <div className="row">
                    <h3 className="text-center text-white">SEO For Enterprises</h3>
                    <p className='text-white text-center mt-2'>Home &gt; SEO</p>
                </div>
            </div>
            ...
            <div className="container p-3">
                <div className="row">
                    <div className="col-md-6 p-4 d-flex flex-column justify-content-center">
                        <h4 className='mb-2'>Give fuel to your startup business digitally and get the highest SEO rankings with our optimized SEO for startup services.</h4>
            ...
            <div className="container p-4">
                <h3 className="text-center mb-2">Invest in Our SEO Services for Startup Business</h3>
                <p className="text-center">
                    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Odit aliquid sed deserunt nobis error neque voluptates, quidem temporibus pariatur facere similique non atque architecto perspiciatis odio aspernatur. Officia, numquam harum.
                </p>
            </div>
            ...
            <div className="container mb-4">
                <div className="row ">
                    <div className="col-md-6 dfjcac mt-4">
                        <div className='dfjcac borderbox2'>
                            <h3 className="text-center mb-2 mt-2">Heading</h3>
                            <p className='tac'>Lorem2 ipsum dolor sit, amet consectetur adipisicing elit. Necessitatibus sit similique iusto nisi reiciendis asperiores voluptate consectetur nam, sequi eligendi cumque at suscipit aperiam, quo expedita temporibus facilis, minima nemo.</p>
                        </div>
                    </div>
