    ...
    return (
        <>
            <div className="container p-2" style={{ background: 'rgb(28, 28, 103)' }}>
                <div className="row">
                    <h3 className="text-center text-white">Google Ads</h3>
                    <p className='text-white text-center mt-2'>Home &gt; Digital Marketing &gt; Google ads</p>
                </div>
            </div>
            ...
            <div className="container">
                ...
                <div className="row p-3">
                    <div className="col-md-4 col-sm-12 dfjcac mt-4">
